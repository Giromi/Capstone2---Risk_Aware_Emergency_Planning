...
from utils.operation import rot_mat_2d, angle_mod, mod2pi
import numpy as np


from capdilib.convention import X, Y, YAW, W, H
...
class DubinsPathPlanner:
    ...
    def __find_local_goal(self) -> list:
        l_rot = rot_mat_2d(self.start[YAW])
