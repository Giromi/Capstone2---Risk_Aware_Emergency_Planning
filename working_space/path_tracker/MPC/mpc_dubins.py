...
def do_simulation(path, cx, cy, cyaw, ck, sp, dl, initial_state):
    """
    Simulation
...
def get_my_course(dl):
    # ax = [0.0, 50.0, 100.0, 200.0, 300.0, 400.0, 500.0]
    # ay = [0.0, 2.0, -2.0, 2.0, -5.0, 10.0, -10.0]
    ax = [0.0, 30.0, 60.0, 90.0, 120.0, 150.0, 180.0, 210.0, 240.0, 270.0, 300.0, 330.0, 360.0, 390.0, 420.0, 450.0, 480.0, 510.0, 540.0, 570.0, 600.0]
    ay = [0.0, 5.0, -3.0, 8.0, -10.0, 12.0, -15.0, 10.0, -5.0, 3.0, -8.0, 15.0, -20.0, 18.0, -12.0, 10.0, -7.0, 5.0, -3.0, 2.0, 0.0]
